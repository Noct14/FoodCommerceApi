 ...
 *                  @OA\Property(
 *                      property="name", type="string", example="TestSW"
 *                  ),
 *                  @OA\Property(
 *                      property="email", type="string", example="TestSW@email.com"
 *                  ),
 *                  @OA\Property(
 *                      property="password", type="string", example="password123"
 *                  )
 *              )
 *         )
 *     ),
 ...
 *              @OA\Schema(
 *                  type="object",
 *                  required={"product_name", "price", "category", "image"},
 *                  @OA\Property(
 ...
 *         @OA\JsonContent(
 *             @OA\Property(property="message", type="string", example="Item cart diupdate")
 *         )
 *     ),
 *     @OA\Response(
 *         response=422,
 ...
 *         @OA\JsonContent(
 *             @OA\Property(property="message", type="string", example="Cart dikosongkan")
 *         )
 *     ),
 *     @OA\Response(
 *         response=401,
